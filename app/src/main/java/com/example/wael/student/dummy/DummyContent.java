package com.example.wael.student.dummy;
...
>>>>>>> parent of 9566f76... implant git in android studio:app/src/main/java/com/example/wael/partie_etudiant/dummy/DummyContent.java
        ...
        Course c3 = new Course(2, "manipuler entiers complexes", "definition de plan complexe (O, I, J, Z) et les regles de calcul complexes ", "http://math.bac/complexe.json", "mathematique pour le bac", "wael Ouni", "2015,04,01");

        Course c4 = new Course(3, "formules trigonométriques", "les differents formules trigoometriques pour les calculs angulaires ", "http://math.2emeSecondaire/trigonoetrie.json", "math pour le 2eme secondaire", "hachem rmida ", "2015,07,19");

        Course c5 = new Course(0, "formes canoniques", "etudes pour les formes canoniques( elipse,spherique ...) dans l'espace ", "http://math.bac/formesCanoniques.json", "math pour le bacc", "Hamdi zinedin", "2015,02,27");

        Course c6 = new Course(1, "variables inconnues d'une equation", "la maniere de calcul les valeurs de variables inconuue dans une equation", "http://math.1ereSec/calculCarInconue.json", "math niveau 1ere Secondaire", "Omar jmal", "2015,11,11");
